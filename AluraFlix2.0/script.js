...
function adicionarFilme() {
    ...
    nomeFilme = document.querySelector('#nomeFilme').value = "" // Limpa o campo de Nome
    imgFilme = document.querySelector('#imgFilme').value = "" // Limpa o campo de Imagem
    trailerFilme = document.querySelector('#trailerFilme').value = "" // Limpa o campo de Trailer
}
